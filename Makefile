...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="fasql" -DDUCKDB_OOT_EXTENSION_FASQL_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_FASQL_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_FASQL_INCLUDE_PATH="$(PROJ_DIR)src/include"
...
test_release: release
	mkdir -p tmp && ./build/release/test/unittest --test-dir . "[sql]"
	rm -rf tmp
